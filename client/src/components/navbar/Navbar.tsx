        ...
        <nav className="shadow row m-0 p-2 align-items-center"
            ...
            <div className="col-5 d-flex m-0 p-0 flex-row justify-content-start align-items-center gap-3">
                ...
                <Link className="nav-link"
                      to="/">{language?.navbar?.home ? language.navbar.home : english.navbar.home}</Link>
            </div>
            <Paper
                component="div"
                className={"d-flex flex-row col-7 align-items-center gap-1 p-1"}>
                <ModeButton/>
                <SearchInput/>
                <VolumeSlider/>
                <ColorPicker/>
                ...
                <a href="https://discord.com/users/468516101639241731" target="_blank">
                    <IconButton
                        ...
                        data-tooltip-content={language?.navbar?.dmOnDiscord ? language.navbar.dmOnDiscord : english.navbar.dmOnDiscord}>
                        <svg style={{width: 24}} xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                             fill="currentColor"
                ...
                <a href="https://github.com/M4rti21/osu-extra-react" target="_blank">
                    <IconButton data-tooltip-id="reactTooltip"
                            data-tooltip-content={language?.navbar?.contribute ? language.navbar.contribute : english.navbar.contribute}>
                        <GitHubIcon/>
                    </IconButton>
                </a>
                <div></div>
