    ...
    return (
        <nav className="shadow row m-0 p-2 align-items-center"
            ...
            <div className="col-5 d-flex m-0 p-0 flex-row justify-content-start align-items-center gap-3">
                ...
                <Link className="nav-link" to="/">{language.navbar.home}</Link>
            </div>
            <Paper
                component="div"
                className={"d-flex flex-row col-7 align-items-center"}>
                <ModeButton/>
                <SearchInput/>
                <VolumeSlider/>
                <ColorPicker/>
                ...
                <IconButton
                    ...
                    data-tooltip-content={language.navbar.dmOnDiscord}
                    onClick={() => {
                        window.location.href = "https://discord.com/users/468516101639241731"
                    }}>
                        <svg  style={{width: 20}} xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                ...
                <IconButton
                    data-tooltip-id="reactTooltip"
                    data-tooltip-content={language.navbar.contribute}
                    onClick={() => {
