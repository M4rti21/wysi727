...
const Keyboard75 = (props: propsInterface) => {
    return (
        <div className="rounded-3 p-2" style={{outline: `solid 1px ${props.colors.ui.font}`}}>
            <div className="d-flex flex-row justify-content-between">
                ...
                <Keycap color={props.inputs.includes('f3') ? props.colors.ui.main : ''}
                        text={'f3'}
                        width={1}/>
                <Keycap color={props.inputs.includes('f4') ? props.colors.ui.main : ''}
                        text={'f4'}
                        width={1}/>
                ...
                <Keycap color={props.inputs.includes('f7') ? props.colors.ui.main : ''}
                        text={'f7'}
                        width={1}/>
                <Keycap color={props.inputs.includes('f8') ? props.colors.ui.main : ''}
                        text={'f8'}
                        width={1}/>
            ...
            <div className="d-flex flex-row justify-content-between">
                ...
                <Keycap color={props.inputs.includes('back') ? props.colors.ui.main : ''}
                        text={'back'}
                        width={2}/>
                <Keycap color={props.inputs.includes('hm') ? props.colors.ui.main : ''}
                        text={'hom'}
                        width={1}/>
            </div>
            <div className="d-flex flex-row justify-content-between">
