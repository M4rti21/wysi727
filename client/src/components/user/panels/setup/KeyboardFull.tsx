...
const KeyboardFull = (props: propsInterface) => {
    return (
            <div className="rounded-3 p-2 d-flex flex-row gap-2" style={{outline: `solid 1px ${props.colors.ui.font}`}}>
                ...
                <div className="d-flex flex-column">
                    ...
                    <div className={"d-flex flex-row mt-2"}>
                        <Keycap color={props.inputs.includes('nlk') ? props.colors.ui.main : ''}
                                text={'nlk'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('div') ? props.colors.ui.main : ''}
                                text={'÷'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('mult') ? props.colors.ui.main : ''}
                                text={'×'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('min') ? props.colors.ui.main : ''}
                                text={'-'}
                                width={1}/>
                    </div>
                    <div className={"d-flex flex-row"}>
                        <Keycap color={props.inputs.includes('n7') ? props.colors.ui.main : ''}
                                text={'7'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('n8') ? props.colors.ui.main : ''}
                                text={'8'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('n9') ? props.colors.ui.main : ''}
                                text={'9'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('nplus') ? props.colors.ui.main : ''}
                                text={' '}
                                width={1}/>
                    </div>
                    <div className={"d-flex flex-row"}>
                        <Keycap color={props.inputs.includes('n4') ? props.colors.ui.main : ''}
                                text={'4'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('n5') ? props.colors.ui.main : ''}
                                text={'5'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('n6') ? props.colors.ui.main : ''}
                                text={'6'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('nplus') ? props.colors.ui.main : ''}
                                text={' '}
                    ...
                    <div className={"d-flex flex-row"}>
                        <Keycap color={props.inputs.includes('n1') ? props.colors.ui.main : ''}
                                text={'1'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('n2') ? props.colors.ui.main : ''}
                                text={'2'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('n3') ? props.colors.ui.main : ''}
                                text={'3'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('nenter') ? props.colors.ui.main : ''}
                                text={' '}
                                width={1}/>
                    </div>
                    <div className={"d-flex flex-row"}>
                        <Keycap color={props.inputs.includes('n0') ? props.colors.ui.main : ''}
                                text={'0'}
                                width={2}/>
                        <Keycap color={props.inputs.includes('npoint') ? props.colors.ui.main : ''}
                                text={'.'}
                                width={1}/>
                        <Keycap color={props.inputs.includes('nenter') ? props.colors.ui.main : ''}
                                text={' '}
